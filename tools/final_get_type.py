...
def get_file_type(dir_path):
    ...
    if os.path.isfile(dir_path):
        ...
        print("kind::::::::::::", kind)
        if kind in ["zip", "exe"] or not kind:
        ...
        for filename in filenames:
            ...
            try:
                ...
                if kind == "zip" or not kind:
                    kind = other_get_type(dir_file_path, filename)
                    if not kind:
...
if __name__ == '__main__':
    ...
    #     print(datetime.datetime.now())
    #     path = input("请输入路径(输入q退出)::")
    # file = open("E:\python_test\dwt\ori\DMP\C453CA37FBD55BF25F43811BB45EF0B9", "r")
    print(get_file_type(r"E:\python_test\dwt/ori/XLS/25A6F9D5EEC62668E6B6593344522E93"))
